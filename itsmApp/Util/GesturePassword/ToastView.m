...
+ (void)showWithText:(NSString *)text_
    ...
    ToastView *toast = [[ToastView alloc] initWithText:text_];
...
{
    [ToastView showWithText:text_ duration:DEFAULT_DISPLAY_DURATION DisplayWindow:window];
}
...
{
    [ToastView showWithText:text_  topOffset:topOffset_ duration:DEFAULT_DISPLAY_DURATION DisplayWindow:window];
}
...
{
    [ToastView showWithText:text_  bottomOffset:bottomOffset_ duration:DEFAULT_DISPLAY_DURATION DisplayWindow:window];
}
