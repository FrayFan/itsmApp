...
#import "CompleteTableView.h"
#import "OtherTableViewCell.h"
#import "BillsDetailController.h"
#import "UIView+ViewController.h"

@implementation CompleteTableView
...
- (void)createRefreshNormalHeader
{
    _normalHeader = [MJRefreshNormalHeader headerWithRefreshingBlock:^{
        ...
        _upRefresh = YES;
        [self.refreshDelegate completeTableViewIsUpRefreshData:_upRefresh];
...
-(CGFloat)tableView:(UITableView *)tableView heightForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (_orderModels.count>0) {
        orderModel = _orderModels[indexPath.row];
    }
